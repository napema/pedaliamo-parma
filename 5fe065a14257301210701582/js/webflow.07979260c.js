...
! function(t) {
	...
	r.define("brand", t.exports = function(t) {
		...
		return n.ready = function() {
			...
			/\.webflow\.io$/i.test(p) && c.hostname !== p && (u = !0), u && !s && (e = e || (n = t('').attr("href", ""), r = t("<img>").attr("src", "g").attr("alt", "").css({
				marginRight: "8px",
				width: "16px"
...
Webflow.require('ix2').init({
	"events": {
		"e": {
			...
			"target": {
				"selector": ".nav-item",
				"originalId": "5dc76a3b-7e71-c4eb-4914-20d4bf4f669f",
				"appliesTo": "CLASS"
			},
			"targets": [{
				"selector": ".nav-item",
		...
		"e-7": {
			...
			"target": {
				"selector": ".blog-card",
				"originalId": "602109d0c7078717a38faa40|e93ff732-c23f-e918-a3f5-30e57d71dbfe",
				"appliesTo": "CLASS"
			},
			"targets": [{
				"selector": ".blog-card",
		...
		"e-15": {
			...
			"mediaQueries": ["main", "medium", "small", "tiny"],
			"target": {
				"selector": ".faq-card-question",
				"originalId": "602109d0c70787132a8faa41|f8961c9f-acfa-ce48-5cf7-1d12a363c479",
				"appliesTo": "CLASS"
			},
			"targets": [{
				"selector": ".faq-card-question",
		...
		"e-26": {
			...
			"target": {
				...
				"originalId": "602109d0c707874ff38faa3c|0291c7d8-53a3-99e8-a064-120d8d97b3b5",
				"appliesTo": "CLASS"
			},
			"targets": [{
				"selector": ".hero-text-wrapper",
		...
		"e-28": {
			...
			"mediaQueries": ["main", "medium", "small", "tiny"],
			"target": {
				"selector": ".feature-column-left",
				"originalId": "602109d0c707874ff38faa3c|3a4f6842-5cfa-5e13-6cb4-14bb16da47a1",
				"appliesTo": "CLASS"
			},
			"targets": [{
				"selector": ".feature-column-left",
		...
		"e-30": {
			...
			"mediaQueries": ["main", "medium", "small", "tiny"],
			"target": {
				"selector": ".feature-column-right",
				"originalId": "602109d0c707874ff38faa3c|3a4f6842-5cfa-5e13-6cb4-14bb16da47a4",
				"appliesTo": "CLASS"
			},
			"targets": [{
				"selector": ".feature-column-right",
		...
		"e-32": {
			...
			"mediaQueries": ["main", "medium", "small", "tiny"],
			"target": {
				"id": "602109d0c707874ff38faa3c|00ea0050-55da-83cd-f679-a3331c5a2e73",
				"appliesTo": "ELEMENT",
				"styleBlockIds": []
			},
			"targets": [{
		...
		"e-34": {
			...
			"target": {
				"selector": ".team-card",
				"originalId": "602109d0c707873cf78faa44|389a7aec-0b33-d904-3491-7780c5ed27a8",
				"appliesTo": "CLASS"
			},
			"targets": [{
				"selector": ".team-card",
		...
		"e-36": {
			...
			"mediaQueries": ["main", "medium", "small", "tiny"],
			"target": {
				"selector": ".roadmap-column-right",
				"originalId": "602109d0c707870e8e8faa43|7d8ed265-d631-4c46-f170-f3ea592e8a5f",
				"appliesTo": "CLASS"
			},
			"targets": [{
				"selector": ".roadmap-column-right",
		...
		"e-38": {
			...
			"mediaQueries": ["main", "medium", "small", "tiny"],
			"target": {
				"selector": ".roadmap-column-left",
				"originalId": "602109d0c707870e8e8faa43|7d8ed265-d631-4c46-f170-f3ea592e8a67",
				"appliesTo": "CLASS"
			},
			"targets": [{
				"selector": ".roadmap-column-left",
		...
		"e-42": {
			...
			"target": {
				"selector": ".faq-card",
				"originalId": "602109d0c70787132a8faa41|f8961c9f-acfa-ce48-5cf7-1d12a363c478",
				"appliesTo": "CLASS"
			},
			"targets": [{
				"selector": ".faq-card",
		...
		"e-44": {
			...
			"mediaQueries": ["main", "medium", "small", "tiny"],
			"target": {
				"id": "602109d0c7078766648faa45|5144a56c-ea31-6dc3-b8da-436d5d9f4826",
				"appliesTo": "ELEMENT",
				"styleBlockIds": []
			},
			"targets": [{
		...
		"e-56": {
			...
			"target": {
				"id": "64f7c90b-04d0-63d6-a0a3-2ff47d181087",
				"appliesTo": "ELEMENT",
				"styleBlockIds": []
			},
			"targets": [{
		...
		"e-62": {
			...
			"mediaQueries": ["main", "medium", "small", "tiny"],
			"target": {
				"selector": ".license-block",
				"originalId": "60210dc626428c00bb247b19|360dd371-c07b-d473-e2ba-6dd525e5b795",
				"appliesTo": "CLASS"
			},
			"targets": [{
				"selector": ".license-block",
		...
		"e-70": {
			...
			"mediaQueries": ["main", "medium", "small", "tiny"],
			"target": {
				"selector": ".style-guide-block",
				"originalId": "602117765f64020066a8f8b2|c12ee107-6f9b-9eee-2d0b-e8f25841e28a",
				"appliesTo": "CLASS"
			},
			"targets": [{
				"selector": ".style-guide-block",
		...
		"e-73": {
			...
			"createdOn": 1614159178285
		}
	},
	"actionLists": {
		"a": {
			"id": "a",
			"title": "On Hover - Nav Item",
			"actionItemGroups": [{
				"actionItems": [{
					"id": "a-n",
					...
					"config": {
						...
						"target": {
							...
							"selector": ".nav-line",
							"selectorGuids": ["2c5d62b9-5786-3f59-cfeb-cce28308cd92"]
						},
						"value": 0,
						"unit": ""
					}
			...
			"createdOn": 1606827068043
		},
		"a-2": {
			"id": "a-2",
			"title": "On Hover Out - Nav Item",
			"actionItemGroups": [{
				"actionItems": [{
					"id": "a-2-n",
					"actionTypeId": "STYLE_OPACITY",
				...
				"actionItems": [{
					...
					"config": {
						...
						"target": {
							...
							"selectorGuids": ["a5c05f41-eacc-ae62-a731-209c60bcf3f8"]
						},
						"globalSwatchId": "86948e15",
						"rValue": 252,
						"bValue": 4,
						"gValue": 195,
						"aValue": 1
		...
		"a-9": {
				...
				"actionItems": [{
					...
					"config": {
						...
						"target": {
							...
							"selector": ".faq-card-answer",
							"selectorGuids": ["18ec5283-e187-d27b-b774-c2b4fec2d0a8"]
						},
						"heightValue": 0,
						"widthUnit": "PX",
						"heightUnit": "PX",
					...
					"config": {
						...
						"target": {
							"useEventTarget": "CHILDREN",
							"selector": ".faq-icon",
							"selectorGuids": ["18ec5283-e187-d27b-b774-c2b4fec2d0a7"]
						},
						"zValue": 0,
						"xUnit": "DEG",
						"yUnit": "DEG",
				...
				"actionItems": [{
					...
					"config": {
						...
						"target": {
							...
							"selector": ".faq-card-question",
							"selectorGuids": ["18ec5283-e187-d27b-b774-c2b4fec2d0a6"]
						},
						"globalSwatchId": "86948e15",
						"rValue": 252,
						"bValue": 4,
			...
			"useFirstGroupAsInitialState": true,
			"createdOn": 1594478348203
		},
		"a-10": {
			"id": "a-10",
			"title": "On 2nd Click - Close FAQ",
			"actionItemGroups": [{
				"actionItems": [{
					"id": "a-10-n",
					"actionTypeId": "STYLE_SIZE",
		...
		"a-11": {
			...
			"actionItemGroups": [{
				"actionItems": [{
					...
					"config": {
						...
						"target": {
							"selector": ".phone",
							"selectorGuids": ["bfc499d6-3442-ec4e-4403-656a9c6191ca"]
						},
						"yValue": 360,
						"zValue": null,
						"xUnit": "DEG",
			...
			"useFirstGroupAsInitialState": false,
			"createdOn": 1606125431654
		},
		"a-13": {
			"id": "a-13",
			"title": "On Load - Endless Logo Marquee",
			"actionItemGroups": [{
				"actionItems": [{
					"id": "a-13-n",
					...
					"config": {
						...
						"duration": 30000,
						"target": {
							"selector": ".logo-image-wrapper",
							"selectorGuids": ["42beb5e4-52d0-1732-1f37-c7d9b813ce44"]
						},
						"xValue": -1180,
						"xUnit": "px",
						"yUnit": "PX",
			...
			"useFirstGroupAsInitialState": false,
			"createdOn": 1607607437975
		},
		"a-15": {
			"id": "a-15",
			"title": "Scroll in View - Fade Up 🧙 (.2)",
			"actionItemGroups": [{
				"actionItems": [{
					"id": "a-15-n",
					"actionTypeId": "TRANSFORM_MOVE",
					"config": {
						...
						"target": {
							"useEventTarget": true,
							"id": "5f7d9d7e0f0e925d24b276a0|1e984e0a-9ca0-3188-fde5-647d9d7523d8"
						},
						"yValue": 50,
						"xUnit": "PX",
						"yUnit": "px",
			...
			"useFirstGroupAsInitialState": true,
			"createdOn": 1601968352154
		},
		"a-18": {
			"id": "a-18",
			"title": "Scroll in View - Feature Column Left 🧙",
			"actionItemGroups": [{
				"actionItems": [{
					"id": "a-18-n",
					"actionTypeId": "TRANSFORM_MOVE",
		...
		"a-19": {
			"id": "a-19",
			"title": "Scroll in View - Feature Column Right🧙",
			"actionItemGroups": [{
				"actionItems": [{
					"id": "a-19-n",
					"actionTypeId": "TRANSFORM_MOVE",
		...
		"a-20": {
			"id": "a-20",
			"title": "On Load - Scroll Down Icon",
			"actionItemGroups": [{
				"actionItems": [{
					"id": "a-20-n-3",
					"actionTypeId": "TRANSFORM_MOVE",
					"config": {
						...
						"duration": 500,
						"target": {
							"selector": ".scroll-down-icon",
							"selectorGuids": ["d8686ead-3fd5-dccb-0067-6b0a86625b4b"]
						},
						"yValue": 4,
						"xUnit": "PX",
						"yUnit": "px",
		...
		"a-5": {
				...
				"actionItems": [{
					...
					"config": {
						...
						"target": {
							...
							"selectorGuids": ["2c5d62b9-5786-3f59-cfeb-cce28308cd95"]
						},
						"yValue": 3,
						"xUnit": "PX",
						"yUnit": "PX",
					...
					"config": {
						...
						"target": {
							"useEventTarget": "CHILDREN",
							"selector": ".burger-line-two",
							"selectorGuids": ["2c5d62b9-5786-3f59-cfeb-cce28308cd9b"]
						},
						"zValue": -45,
						"xUnit": "DEG",
						"yUnit": "DEG",
			...
			"useFirstGroupAsInitialState": false,
			"createdOn": 1598444819192
		},
		"a-6": {
			"id": "a-6",
			"title": "On 2nd Click - Close Menu",
			"actionItemGroups": [{
				"actionItems": [{
					"id": "a-6-n",
					"actionTypeId": "TRANSFORM_MOVE",
